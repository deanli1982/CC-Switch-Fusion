...
export interface Provider {
  ...
  // 新增：是否为商业合作伙伴
  isPartner?: boolean;
  // 可选：供应商元数据（仅存于 ~/.cc-switch-fusion/config.json，不写入 live 配置）
  meta?: ProviderMeta;
  // 图标配置
...
// 存储在本地 ~/.cc-switch-fusion/settings.json，不随数据库同步
export interface Settings {
  ...
  fusionModelMapping?: FusionModelMapping;
}
...
// ============================================================================
// Fusion Model Mapping — Cross-provider model routing
// ============================================================================

export interface FusionMappingEntry {
  providerId: string;
  modelName: string;
}
...
export interface FusionModelMapping {
  enabled: boolean;
  autoImageToHaiku?: boolean;
  haiku?: FusionMappingEntry;
  sonnet?: FusionMappingEntry;
  opus?: FusionMappingEntry;
  default?: FusionMappingEntry;
}
