...
import { FusionModelMappingPage } from "@/components/settings/FusionModelMappingPage";
        ...
        >
          <TabsList className="grid w-full grid-cols-7 mb-6 glass rounded-lg">
            ...
            <TabsTrigger value="fusion">
              {t("settings.tabFusion", { defaultValue: "Fusion" })}
            </TabsTrigger>
          ...
          <div className="flex-1 min-h-0 flex flex-col">
            <div className="flex-1 overflow-y-auto overflow-x-hidden pr-2">
              ...
              <TabsContent value="fusion" className="space-y-6 mt-0 pb-4">
                {settings ? (
                  <FusionModelMappingPage
                    value={
                      settings.fusionModelMapping ?? { enabled: false }
                    }
                    onChange={(mapping) =>
                      handleAutoSave({ fusionModelMapping: mapping })
                    }
                  />
                ) : null}
              </TabsContent>
