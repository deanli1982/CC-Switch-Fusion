...
import { FusionChannelBar } from "@/components/FusionChannelBar";
...
const STORAGE_KEY = "cc-switch-fusion-last-app";
...
const VIEW_STORAGE_KEY = "cc-switch-fusion-last-view";
            ...
            {currentView !== "providers" ? (
              ...
              <div className="flex items-center gap-2">
                <div className="relative inline-flex items-center">
                  <a
                    href="https://github.com/farion1231/cc-switch-fusion"
                    target="_blank"
                    rel="noreferrer"
                    className={cn(
